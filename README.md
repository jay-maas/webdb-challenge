...
RDMS = system used to manage relational databases. SQL is a language that allows for interaction with the system

1. Why do tables need a `primary key`?

A primary key is needed inside of a table so that way it has a way to be identified out of context of its table. 
